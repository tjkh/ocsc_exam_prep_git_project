...
function searchPage(filter) {
var table, tr, td, i;
var context = document.querySelector(".myTable"); //belongs to searchhi.js

  table = document.getElementById("myTable");
  th = table.getElementsByTagName("th");
  if (filter != "พิมพ์สุภาษิต/สำนวน ..." || filter != "*")
  {
