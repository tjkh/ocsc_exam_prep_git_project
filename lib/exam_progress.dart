class ExamProgress {
  ...
  ExamProgress({
    ...
    required this.trailing_pic_name,
  ...
  fromMap(Map map) {
    ExamProgress progress = new ExamProgress(
        ...
        trailing_pic_name: trailing_pic_name,
    ...
    progress.isClicked = map["isClicked"];
...
// @override
  String toString() {
    return '$id, $file_name, $progress_pic_name, $trailing_pic_name, $dateCreated, $isClicked, $exam_type, $field_2, $position, $open_last, $field_5}';
  }
}
//
